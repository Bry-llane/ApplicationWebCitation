Ce projet vise à développer une application web en utilisant Node.js et React. L'application permettra de gérer un recueil de citations avec deux points d'entrée principaux :
